  ...
  <>
    ...
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="overflow-y-auto max-h-[70vh] p-4 border rounded bg-white text-gray-800 text-sm space-y-4">
        <p>
          These Terms of Use set out the terms and conditions for use of this THE ANALYTICS CAREER (“Website”) and any content, Public Forums, or services offered on or through the Website and/or through any mobile application(s) (“Application”) (collectively referred to as the “Platform”).
        </p>
        <p>
        ...
        <p>
          When we speak of “Creator”, ‘we’, ‘us’, and ‘our’, we collectively mean THE ANALYTICS CAREER being the creator of this Platform and the content/materials/services contained therein.
        </p>
        <p>
        ...
        <h2 className="font-semibold mt-6">Access and Registration</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">License to Use</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Communications</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Code of Conduct</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Intellectual Property</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Feedback</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Payments and Refunds</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Limitation of Liability</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Indemnity and Release</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Links to Third Party Website</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Governing Law and Jurisdiction</h2>
        <p>
        ...
        <h2 className="font-semibold mt-6">Miscellaneous</h2>
        <p>
          <strong>Alteration of Platform or Amendments to the Conditions:</strong> We reserve the right to make changes to our Platform, policies, and this Agreement at any time. We will post the new terms with a revision date indicated at the top or if deemed practicable. You should check our Platform frequently to see recent changes. You will be subject to the Agreement and the policies in force at the time that You use the Platform or any part thereof, unless any change to those policies or these conditions is required to be made by law or government authority (in which case it will apply to orders previously placed by You). If any of these conditions is deemed invalid, void, or for any reason unenforceable, that condition will be deemed severable and will not affect the validity and enforceability of any remaining condition.
        </p>
        <p>
          <strong>Waiver:</strong> If You breach these conditions and we take no action, we will still be entitled to use our rights and remedies in any other situation where You breach these conditions.
        </p>
        <p>
          <strong>Assignment:</strong> You may not assign or transfer this Agreement, by operation or law or otherwise. Any attempt by You to assign or transfer this Agreement will be null and void.
        </p>
        <p>
          <strong>Severability:</strong> If any provision of this Agreement will be adjudged by any court of competent jurisdiction to be unenforceable or invalid, that provision will be limited to the minimum extent necessary so that this Agreement will otherwise remain in effect.
        </p>
        <p>
          <strong>Events beyond our reasonable control:</strong> We will not be held responsible for any delay or failure to comply with our obligations under these conditions if the delay or failure arises from any cause which is beyond our reasonable control. This condition does not affect Your statutory rights.
        </p>
        <h2 className="font-semibold mt-6">Contact Us</h2>
        <p>
          If You’ve have concerns or queries regarding this Agreement, You may write to us by email at <a href="mailto:theanalyticscareer@gmail.com" className="text-blue-600 underline">theanalyticscareer@gmail.com</a>.
        </p>
      </div>
